...
$('#summa_trof').val(price_trof + +price_veter + +price_razdel);
$('#summa_tour_eger').val(price_eger);
...
$('.price_block, .price_block input, .price_block select, .ui-datepicker, a.finish').on('click keyup', valParam);
});
</script>
...
<?php if( get_field('page_tour_reg') ): ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="item_form">
                                          ...
                                          <input id="tour_start" type="text" placeholder="<?php echo $start_date->format('j/m/Y'); ?>" class="datepicker">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="item_form">
                                            ...
                                            <div class="icon">
                                                <i class="material-icons">today</i>
                                          <input id="tour_finish" type="text" placeholder="<?php echo $finish_date->format('j/m/Y'); ?>" class="datepicker">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="price_finish">
                                    ...
                                    <a href="#modal_form_price" class="finish" data-fancybox>Забронировать тур</a><br>
...
<?php endif; ?>
                            ...
                            <section class="margin_bottom info_block">
                                <div class="row_title">Транспорт</div>
